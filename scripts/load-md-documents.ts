...
export async function loadMDDocuments(options: CliOptions) {
...
if (entrypointPath === currentFilePath) {
  loadMDDocuments(parseArgs(process.argv.slice(2))).catch((error: unknown) => {
